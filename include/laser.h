...
private:
    double map_size_, senor_x_, sensor_y_, sensor_toward_angle_, max_dis_;
    ...
    void LocalToGlobl(double toward_angle, double dis, double local_x, double local_y, double& global_x, double& global_y, double robot_x, double robot_y, double robot_yaw)
    {
        double x = TransCoordinate(local_x, local_y, sensor_toward_angle_, dis * cos(toward_angle), dis * sin(toward_angle)).first;
        double y = TransCoordinate(local_x, local_y, sensor_toward_angle_, dis * cos(toward_angle), dis * sin(toward_angle)).second;
